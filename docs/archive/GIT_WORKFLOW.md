> ⚠️ **بایگانی شد (۲۰۲۶-۰۸-۱۵):** این فایل راهنمای داخلی کار تیمی با گیت در
> فاز جمع‌آوری/توسعه پروژه بود؛ الان که پروژه به مرحله ارائه رسیده دیگر
> کاربرد عملیاتی ندارد. محتوایش برای مرجع تاریخی نگه داشته شده — پاک نشده.
